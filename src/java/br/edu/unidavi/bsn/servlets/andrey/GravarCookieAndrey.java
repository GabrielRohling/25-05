package br.edu.unidavi.bsn.servlets.andrey;
...
@WebServlet(name = "GravarCookieAndrey", urlPatterns = {"/GravarCookieAndrey"})
public class GravarCookieAndrey extends HttpServlet {
