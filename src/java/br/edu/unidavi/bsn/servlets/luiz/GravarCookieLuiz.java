package br.edu.unidavi.bsn.servlets.luiz;
...
@WebServlet(name = "GravarCookieLuiz", urlPatterns = {"/GravarCookieLuiz"})
public class GravarCookieLuiz extends HttpServlet {
